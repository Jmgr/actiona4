...
> <span class="async-badge">async</span> **waitForMovement**(`options?`: [`WaitForMovementOptions`](WaitForMovementOptions.md)): [`Task`](../type-aliases/Task.md)\<[`Point`](../classes/Point.md)\>
...
[`WaitForMovementOptions`](WaitForMovementOptions.md)
...
[`Task`](../type-aliases/Task.md)\<[`Point`](../classes/Point.md)\>
