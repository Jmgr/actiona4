...
const config: Config = {
  ...
  future: {
    ...
    // Docusaurus 3.10 enables Faster-by-default when v4 is true, which
    // requires the optional @docusaurus/faster package. Keep Faster off
    // unless we add that dependency explicitly.
    faster: false,
  },
    ...
    [
      "docusaurus-plugin-typedoc",
      {
        plugin: [
          ...
          "./plugins/typedoc-plugin-platform-icons.mjs",
          "./plugins/typedoc-plugin-expand-options.mjs",
        ],
        entryPoints: ["../crates/run/assets/index.d.ts"],
        tsconfig: "../crates/run/assets/tsconfig.json",
        out: "docs/api",
        entryFileName: "index",
        readme: "none",
