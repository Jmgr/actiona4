/**
 * Generated by doc-generator 1.0.0. DO NOT EDIT.
 */
...
declare class File {
     ...
     * ```
     */
    static open(path: string, options?: OpenOptions): File;
    /**
    ...
    static write(path: string, data: Uint8Array): void;
    ...
    accessedTime(): Date;
    setAccessedTime(date: Date): void;
    createdTime(): Date;
    /**
    ...
    setRelativePosition(offset: number): void;
    rewind(): void;
    path(): string;
    clone(): File;
